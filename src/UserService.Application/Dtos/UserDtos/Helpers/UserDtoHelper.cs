...
public static class UserDtoHelper
{
    ...
    {
        return Address.Create(dto.AddressLine, dto.City, dto.ZipCode, dto.Country,
            dto.AddressSupplement, dto.StateProvince);
    }
    ...
    public static Result<User> ToUser(UserDto dto)
    {
        ...
        return User.Create(dto.Id, dto.EmailAddress, dto.HashedPassword,
            dto.FirstName, dto.LastName, dto.Birthday, dto.Gender, dto.Role, dto.Phone, address.Value);
    }
}
